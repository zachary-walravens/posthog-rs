...
mod minimal_gate_tests {
    ...
    #[test]
    fn local_evaluation_normalizes_string_encoded_payload() {
        let cache = FlagCache::new();
    ...
    #[test]
    fn local_evaluation_parses_scalar_string_payload() {
        let cache = FlagCache::new();
    ...
    #[test]
    fn local_evaluation_keeps_unparseable_payload_as_string() {
        let cache = FlagCache::new();
